...
public class BusDAO{
	public List<Bus> findByStationId(String arsid) throws MalformedURLException, IOException, JSONException{
		...
		HttpURLConnection connection=(HttpURLConnection) new URL("http://ws.bus.go.kr/api/rest/stationinfo/getStationByUid?serviceKey=09E5I22CgJDmsPluG0%2FPgQA6tN2M4VCDOqoZOnW3LpiZ5fmRVDF5JDz2D%2FMmngQ19xcOFEZ8jtoFCa21Xajxeg%3D%3D&"+"arsId="+arsid).openConnection();
